...
describe('DURABLE | goodbye | `search, waitFor` | Postgres', () => {
  ...
  describe('WorkflowHandle', () => {
    describe('result', () => {
      ...
      it('should retrieve all user data fields', async () => {
        ...
        const allUserData = await Durable.Search.findAllUserData(workflowGuid, hotMeshClient);
        ...
        expect(allUserData.custom1).toBe('durable');
