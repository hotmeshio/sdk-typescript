...
describe('utils module', () => {
  ...
  describe('utils.matchesStatus function', () => {
    ...
    it('should not match StreamStatus.SUCCESS with StreamStatus.ERROR', () => {
        expect(utils.matchesStatus(StreamStatus.SUCCESS, StreamStatus.ERROR)).toBe(false);
    });

    it('should match StreamStatus.ERROR with StreamStatus.ERROR', () => {
        expect(utils.matchesStatus(StreamStatus.ERROR, StreamStatus.ERROR)).toBe(true);
    });

    it('should not match StreamStatus.ERROR with StreamStatus.PENDING', () => {
        expect(utils.matchesStatus(StreamStatus.ERROR, StreamStatus.PENDING)).toBe(false);
    });
